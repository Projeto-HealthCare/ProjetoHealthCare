<?php 
    ...
    var_dump($_COOKIE['correct']);

    $questao = $_COOKIE["question5"];
    $sql = "SELECT conteudo FROM questao WHERE id_questao = '$questao'";
    $conteudo = "";
    foreach($bd->query($sql) as $row){
        $conteudo = $row['conteudo'];
    }

    $alternativas = $bd->query("SELECT * FROM alternativa WHERE id_questao = '$questao'")->fetchAll();
?>
...
<head>
    ...
    <script type="text/javascript">
        var resp1 = <?php echo $alternativas[0]["alternativa_correta"]; ?>;
        var resp2 = <?php echo $alternativas[1]["alternativa_correta"]; ?>;
        var resp3 = <?php echo $alternativas[2]["alternativa_correta"]; ?>;
        var resp4 = <?php echo $alternativas[3]["alternativa_correta"]; ?>;
        var resp5 = <?php echo $alternativas[4]["alternativa_correta"]; ?>;
        var respondido = 0;
        var arr = document.cookie.split(";");
        var aux = arr[6].split("=");
        var correct = parseInt(aux[1]);
        console.log(correct);




        function handleAlternative(button){
            if(respondido == 0){
                if(resp1){
                document.getElementById("alternative1").style.backgroundColor= "#4bd448";
                document.getElementById("alternative2").style.backgroundColor= "#e33d3d";
                document.getElementById("alternative3").style.backgroundColor= "#e33d3d";
                document.getElementById("alternative4").style.backgroundColor= "#e33d3d";
                document.getElementById("alternative5").style.backgroundColor= "#e33d3d";
                document.getElementById("alternativeText1").style.color= "#fff";
                document.getElementById("alternativeText2").style.color= "#fff";
                document.getElementById("alternativeText3").style.color= "#fff";
                document.getElementById("alternativeText4").style.color= "#fff";
                document.getElementById("alternativeText5").style.color= "#fff";
                if(button == 1)
                    correct++;
                }
                else if(resp2){
                    document.getElementById("alternative1").style.backgroundColor= "#e33d3d";
                    document.getElementById("alternative2").style.backgroundColor= "#4bd448";
                    document.getElementById("alternative3").style.backgroundColor= "#e33d3d";
                    document.getElementById("alternative4").style.backgroundColor= "#e33d3d";
                    document.getElementById("alternative5").style.backgroundColor= "#e33d3d";
                    document.getElementById("alternativeText1").style.color= "#fff";
                    ...
                    document.getElementById("alternative1").style.backgroundColor= "#e33d3d";
                    document.getElementById("alternative2").style.backgroundColor= "#e33d3d";
                    document.getElementById("alternative3").style.backgroundColor= "#4bd448";
                    document.getElementById("alternative4").style.backgroundColor= "#e33d3d";
                    document.getElementById("alternative5").style.backgroundColor= "#e33d3d";
                    document.getElementById("alternativeText1").style.color= "#fff";
                    document.getElementById("alternativeText2").style.color= "#fff";
                    ...
                    document.getElementById("alternative2").style.backgroundColor= "#e33d3d";
                    document.getElementById("alternative3").style.backgroundColor= "#e33d3d";
                    document.getElementById("alternative4").style.backgroundColor= "#4bd448";
                    document.getElementById("alternative5").style.backgroundColor= "#e33d3d";
                    document.getElementById("alternativeText1").style.color= "#fff";
                    document.getElementById("alternativeText2").style.color= "#fff";
                    document.getElementById("alternativeText3").style.color= "#fff";
                    ...
                    document.getElementById("alternative3").style.backgroundColor= "#e33d3d";
                    document.getElementById("alternative4").style.backgroundColor= "#e33d3d";
                    document.getElementById("alternative5").style.backgroundColor= "#4bd448";
                    document.getElementById("alternativeText1").style.color= "#fff";
                    document.getElementById("alternativeText2").style.color= "#fff";
                    document.getElementById("alternativeText3").style.color= "#fff";
                    document.getElementById("alternativeText4").style.color= "#fff";
    ...
    <?php 
        function teste(){
            $respondido = "<script> document.write(respondido) </script>";
            return $respondido;
        }
    ?>
</head>
            ...
            <div class="home-box custom-box">
                ...
                <div class="questionBox">
                    ...
                    <form action="./question6.php" method="POST">
                        <div class="alternativeBox">
                            <button type="button" name="botao" value="1" id="alternative1" onclick="handleAlternative(this.value)">
                                <h3 id="alternativeText1"><?php echo $alternativas[0]["enunciado"] ?></h3>
                            </button>
                            <button type="button" name="botao"  value="2" id="alternative2" onclick="handleAlternative(this.value)">
                                <h3 id="alternativeText2"><?php echo $alternativas[1]["enunciado"] ?></h3>
                            </button>
                            <button type="button" name="botao"  value="3" id="alternative3" onclick="handleAlternative(this.value)">
                                <h3 id="alternativeText3"><?php echo $alternativas[2]["enunciado"] ?></h3>
                            </button>
                            <button type="button" name="botao"  value="4" id="alternative4" onclick="handleAlternative(this.value)">
                                <h3 id="alternativeText4"><?php echo $alternativas[3]["enunciado"] ?></h3>
                            </button>
                            <button type="button" name="botao"  value="5" id="alternative5" onclick="handleAlternative(this.value)">
                                <h3 id="alternativeText5"><?php echo $alternativas[4]["enunciado"] ?></h3>
                            </button>
                        </div>
                        <div class="submitBox">
                            <button type="submit" class="btn btn-third" >Próxima</button>
                        </div>
                    </form>
                </div>
            </div>
